...
public class PlayerController2 : MonoBehaviour
{
    ...
    public void jump()
    {
        ...
        {
            animator.SetBool("ResetJump", true);
        }
    }
    ...
    //Setzt den Spieler auf die letzte sichere Position zur�ck, falls er ins Wasser f�llt
    ...
    {
        move = new Vector2(0, 0);
        go.transform.position = new Vector3(-235, 3, 9);
        playerHealth = 100;
    }
    ...
    void healPalyer()
    {
        ...
        //Regeneriere Leben
        if (playerHealth < 100 && healDelay <= 0)
        {
            playerHealth += 10;
            healDelay = 40;
        }
